    ...
    <div className=" sm:w-[375px] rounded-3xl overflow-hidden w-[300px]">
      ...
      {!isLoading ? (
        <div className=" bg-[#4643D3]  px-8 py-[22px] ">
          <div className="grid grid-cols-6">
            ...
            <div className="flex  justify-start space-x-4 col-span-5 mb-[17px]">
              ...
              />
              <div>
                <h3 className=" text-white font-semibold text-lg leading-[21.94px] tracking-[0.25px]">
                  {name}
                </h3>
            ...
            <XIcon
              className="text-white col-span-1 col-end-8 text-base h-[17px] w-[17px] cursor-pointer opacity-[50%]"
              onClick={() => onClose()}
            />
          </div>
          <div>
            <p className=" text-white font-normal text-base leading-[24px] ">
              {messageText}
            </p>
          </div>
        </div>
        ...
        <div className=" h-[154px]  bg-[#4643D3] shadow px-8 py-[22px] max-w-sm w-full mx-auto ">
          <XIcon
            className="text-white text-base h-[17px] w-[17px] float-right cursor-pointer opacity-[50%]"
            onClick={() => onClose()}
          />
